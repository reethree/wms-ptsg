...
<script>
    ...
    {
        var ids = jQuery("#lclSuratJalanGrid").jqGrid('getDataIDs');   
            
        for(var i=0;i < ids.length;i++){ 
            var cl = ids[i];
            
            rowdata = $('#lclSuratJalanGrid').getRowData(cl);
        ...
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-12"> 
                {{
                    ...
                    ->addColumn(array('label'=>'No.BC11','index'=>'NO_BC11', 'width'=>150,'hidden'=>true,'align'=>'center'))
                    ->addColumn(array('label'=>'Tgl.BC11','index'=>'TGL_BC11', 'width'=>150,'hidden'=>true,'align'=>'center'))
                    ...
                    ->addColumn(array('label'=>'Tgl. Fiat Muat','index'=>'tglfiat', 'width'=>120,'hidden'=>true,'align'=>'center'))
                    ->addColumn(array('label'=>'Jam. Fiat Muat','index'=>'jamfiat', 'width'=>70,'hidden'=>true,'align'=>'center'))
