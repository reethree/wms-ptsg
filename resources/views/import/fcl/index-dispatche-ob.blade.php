...
<script>
    ...
    {
        var ids = jQuery("#fclDispatcheGrid").jqGrid('getDataIDs'),
            apv = '',
            upl = '';    
        ...
        for(var i=0;i < ids.length;i++){ 
            ...
            rowdata = $('#fclDispatcheGrid').getRowData(cl);
...
//                $("#" + cl).find("td").css("color", "#999999");
            ...
            jQuery("#fclDispatcheGrid").jqGrid('setRowData',ids[i],{action:apv+' '+upl}); 
        } 
    }
...
//            }
        ...
        $('#btn-save').click(function() {
            ...
            var url = "{{route('fcl-dispatche-update','')}}/"+containerId;
